...
- target_update_norms: `[1e-05, 2e-05, 5e-05, 0.0001, 0.0002, 0.0005, 0.001, 0.002, 0.005, 0.01, 0.02, 0.05]`
...
```json
{
  "current_grad": {
    ...
    "per_norm": {
      ...
      "2e-03": {
        "current_batch": {
          "critic_loss_delta": -0.008463352918624878,
          "target_pearson_delta": 0.002520740032196045
        },
        "held_out_batch": {
          "critic_loss_delta": -0.004847884178161621,
          "target_pearson_delta": 0.00028008222579956055
        },
        "probe": {
          "critic_loss_delta": -0.007451355457305908,
          "target_pearson_delta": -0.0004960894584655762
        }
      },
      "5e-03": {
        "current_batch": {
          "critic_loss_delta": -0.020920932292938232,
          "target_pearson_delta": 0.0064084529876708984
        },
        "held_out_batch": {
          "critic_loss_delta": -0.011967182159423828,
          "target_pearson_delta": 0.000691533088684082
        },
        "probe": {
          "critic_loss_delta": -0.01853126287460327,
          "target_pearson_delta": -0.0012508630752563477
        }
      },
      "1e-02": {
        "current_batch": {
          "critic_loss_delta": -0.04106113314628601,
          "target_pearson_delta": 0.01321321725845337
        },
        "held_out_batch": {
          "critic_loss_delta": -0.023411303758621216,
          "target_pearson_delta": 0.0013548731803894043
        },
        "probe": {
          "critic_loss_delta": -0.03673672676086426,
          "target_pearson_delta": -0.002536565065383911
        }
      },
      "2e-02": {
        "current_batch": {
          "critic_loss_delta": -0.07898014783859253,
          "target_pearson_delta": 0.028302371501922607
        },
        "held_out_batch": {
          "critic_loss_delta": -0.04470103979110718,
          "target_pearson_delta": 0.002599000930786133
        },
        "probe": {
          "critic_loss_delta": -0.0720827579498291,
          "target_pearson_delta": -0.005213707685470581
        }
      },
      "5e-02": {
        "current_batch": {
          "critic_loss_delta": -0.14896327257156372,
          "target_pearson_delta": 0.08559894561767578
        },
        "held_out_batch": {
          "critic_loss_delta": -0.09558877348899841,
          "target_pearson_delta": 0.0057013630867004395
        },
        "probe": {
          "critic_loss_delta": -0.1689002513885498,
          "target_pearson_delta": -0.014091312885284424
        }
      }
    }
  },
  "global_grad": {
    ...
    "per_norm": {
      ...
      "2e-03": {
        "current_batch": {
          "critic_loss_delta": -0.006926745176315308,
          "target_pearson_delta": 0.00042068958282470703
        },
        "held_out_batch": {
          "critic_loss_delta": -0.007709085941314697,
          "target_pearson_delta": 0.000563502311706543
        },
        "probe": {
          "critic_loss_delta": -0.010067999362945557,
          "target_pearson_delta": -0.0006578564643859863
        }
      },
      "5e-03": {
        "current_batch": {
          "critic_loss_delta": -0.017133265733718872,
          "target_pearson_delta": 0.0010900497436523438
        },
        "held_out_batch": {
          "critic_loss_delta": -0.019184738397598267,
          "target_pearson_delta": 0.0013787150382995605
        },
        "probe": {
          "critic_loss_delta": -0.025074303150177002,
          "target_pearson_delta": -0.0016646385192871094
        }
      },
      "1e-02": {
        "current_batch": {
          "critic_loss_delta": -0.033630430698394775,
          "target_pearson_delta": 0.0023163557052612305
        },
        "held_out_batch": {
          "critic_loss_delta": -0.03805261850357056,
          "target_pearson_delta": 0.00264817476272583
        },
        "probe": {
          "critic_loss_delta": -0.04982280731201172,
          "target_pearson_delta": -0.003397643566131592
        }
      },
      "2e-02": {
        "current_batch": {
          "critic_loss_delta": -0.06444934010505676,
          "target_pearson_delta": 0.0052391886711120605
        },
        "held_out_batch": {
          "critic_loss_delta": -0.0742645263671875,
          "target_pearson_delta": 0.0047855377197265625
        },
        "probe": {
          "critic_loss_delta": -0.09821748733520508,
          "target_pearson_delta": -0.007077693939208984
        }
      },
      "5e-02": {
        "current_batch": {
          "critic_loss_delta": -0.12777617573738098,
          "target_pearson_delta": 0.018741905689239502
        },
        "held_out_batch": {
          "critic_loss_delta": -0.14963451027870178,
          "target_pearson_delta": 0.006596207618713379
        },
        "probe": {
          "critic_loss_delta": -0.23336321115493774,
          "target_pearson_delta": -0.019987404346466064
        }
      }
    }
  },
  "blended_grad": {
    ...
    "per_norm": {
      ...
      "2e-03": {
        "current_batch": {
          "critic_loss_delta": -0.007621556520462036,
          "target_pearson_delta": 0.0010647773742675781
        },
        "held_out_batch": {
          "critic_loss_delta": -0.0072064995765686035,
          "target_pearson_delta": 0.0005286931991577148
        },
        "probe": {
          "critic_loss_delta": -0.009557187557220459,
          "target_pearson_delta": -0.0006509721279144287
        }
      },
      "5e-03": {
        "current_batch": {
          "critic_loss_delta": -0.01885700225830078,
          "target_pearson_delta": 0.002715885639190674
        },
        "held_out_batch": {
          "critic_loss_delta": -0.017903655767440796,
          "target_pearson_delta": 0.0012974143028259277
        },
        "probe": {
          "critic_loss_delta": -0.02379584312438965,
          "target_pearson_delta": -0.0016454458236694336
        }
      },
      "1e-02": {
        "current_batch": {
          "critic_loss_delta": -0.03703945875167847,
          "target_pearson_delta": 0.005630850791931152
        },
        "held_out_batch": {
          "critic_loss_delta": -0.0354120135307312,
          "target_pearson_delta": 0.0025100111961364746
        },
        "probe": {
          "critic_loss_delta": -0.047262489795684814,
          "target_pearson_delta": -0.003351181745529175
        }
      },
      "2e-02": {
        "current_batch": {
          "critic_loss_delta": -0.0711279809474945,
          "target_pearson_delta": 0.012207627296447754
        },
        "held_out_batch": {
          "critic_loss_delta": -0.06900635361671448,
          "target_pearson_delta": 0.004639089107513428
        },
        "probe": {
          "critic_loss_delta": -0.09308910369873047,
          "target_pearson_delta": -0.006951421499252319
        }
      },
      "5e-02": {
        "current_batch": {
          "critic_loss_delta": -0.13494747877120972,
          "target_pearson_delta": 0.04022473096847534
        },
        "held_out_batch": {
          "critic_loss_delta": -0.14446690678596497,
          "target_pearson_delta": 0.0077855587005615234
        },
        "probe": {
          "critic_loss_delta": -0.22065043449401855,
          "target_pearson_delta": -0.01938319206237793
        }
      }
    }
  }
